# Emmanuel Ejeagha  
### [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=comfortaa&color=016EEA&size=24&width=750&height=50&lines=Software+Engineer;C#+.NET+Backend+Developer;Aspiring+FinTech+Engineer;Fullstack+Developer;DevOps+Enthusiast;AI+Learner;Software+Engineer+|+Backend+.NET+Developer;C#,+ASP.NET+Core,+REST+APIs;Server-Side+Development)](https://git.io/typing-svg)
